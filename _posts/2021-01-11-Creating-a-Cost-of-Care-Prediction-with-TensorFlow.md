...
The dataset we use for training is a public dataset from [Kaggle][5] with a small sample of USA population medical insurance costs. It has 1338 records, with columns as follows:
<br/><br/>
